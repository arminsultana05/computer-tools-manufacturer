    ...
    return (
        ...
        <form className='flex flex-col items-center  ' onSubmit={handleSubmit(onSubmit)}>
           ...
           <input className=' mt-5 border border-gray-600 w-96' placeholder='Photo URL' type="text" {...register("img")} />
            <input className=' mt-5 border border-gray-600 w-96' placeholder='Available Quantity' type="number" {...register("availableQty")} />
            <input className=' mt-5 border border-gray-600 w-96' placeholder='Min Order Quantity' type="number" {...register("minOrrderQty")} />
            <input className=' mt-5 border border-gray-600 w-96' placeholder='Per Unit Price' type="number" {...register("perUnitPrice")} />

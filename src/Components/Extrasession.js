           ...
           <h1 className='text-3xl mt-24  mb-5 text-center text-primary font-bold py-6'>SELECT YOUR PACKAGE!!!</h1>
            ...
            <div class="card w-96 bg-base-200 text-neutral-content">
                <div class="card-body items-center text-center text-neutral">
                    <h2 class=" bg-orange-300 w-96 py-10 -mt-14 text-4xl">Basic <br /> <span className='text-xl'>PERFECT FOR SIMPLE MANUFACTURE</span></h2>
                    <p className='text-5xl font-semibold mb-9 p-7 mt-9'>$15.00.</p>
                    <div class="card-actions justify-end">
                        <button class="btn btn-primary p-4">ORDER NOW</button>
                    </div>
                </div>
            </div>
            <div class="card w-96 bg-base-200 text-neutral-content">
                <div class="card-body items-center text-center text-neutral">
                    <h2 class=" bg-orange-300 w-96 py-10 -mt-14 text-4xl">Standard <br /> <span className='text-xl'>MOST POPULAR</span></h2>
            ...
            <div class="card w-96 bg-base-200 text-neutral-content">
                <div class="card-body items-center text-center text-neutral">
                    <h2 class=" bg-orange-300 w-96 py-10 -mt-14 text-4xl">Ultimate <br /> <span className='text-xl'>ALL SERVICES ARE INCLUDED</span></h2>
